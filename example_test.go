...
func ExampleCredential_x509Authentication() {
	...
	// 		subject= CN=Example App,OU=MongoDB Client Authentication,O=phoenixxliu,C=GB
	//
	//
	// And then create the user in MongoDB with the above DN:
	//
	//		db.getSiblingDB("$external").runCommand({
	//			createUser: "CN=Example App,OU=MongoDB Client Authentication,O=phoenixxliu,C=GB",
	//			roles: [
